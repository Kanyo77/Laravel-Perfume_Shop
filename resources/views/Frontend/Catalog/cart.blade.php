...
?>
    ...
    <div class="hero-wrap hero-bread" style="background-image: {{url('Frontend/images/bg_6.jpg')}};">
      <div class="container">src="{{url('Frontend/images/bg_6.jpg')}}"
								...
								<tbody>
								   <?php 
									 ...
									 if(mysqli_num_rows($select_user) > 0){
										...
										{  
											$id_cart=$fetch_cart['id_cart'];
										?>
										<tr class="text-center">
										 <td class="product-remove"><a href="{{route('cart.delete',$fetch_cart['id_cart'])}}"><span class="ion-ios-close"></span></a></td>
										 <td >
											<?php echo $fetch_cart['id_cart']?>
										 ...
										 <td class="quantity">
											<div class="input-group mb-3">
											 <input type="text" name="quantity" class="quantity form-control input-number" value="<?php echo $fetch_cart['quantity'];?> " max="100">
										   </div>
										</td>
			
										 <td class="total"><?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?></td>
										</tr><!-- END TR-->
